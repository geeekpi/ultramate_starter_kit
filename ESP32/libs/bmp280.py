...
class Device:
    ...
    Allows reading and writing 8-bit, and byte array values to Registers
    on the device."""

    def __init__(self, address, i2c):
        """Create an instance of the I2C device at the specified address
        using the specified I2C interface object."""
    ...
    def readU8(self, register):
        """Read an unsigned byte from specified register."""
        return int.from_bytes(self._i2c.readfrom_mem(self._address,register, 1),'little') & 0xFF

    def readS8(self, register):
        """Read a signed byte from specified register."""
    ...
    def readU16(self, register, little_endian=True):
        """Read an unsigned 16-bit value from specified register.
...
class BMP280:
    def __init__(self, mode=BMP280_OSAMPLE_1, address=BMP280_I2CADDR, i2c=None,
        ...
        if mode not in [BMP280_OSAMPLE_1, BMP280_OSAMPLE_2,
                BMP280_OSAMPLE_4, BMP280_OSAMPLE_8, BMP280_OSAMPLE_16]:
            raise ValueError(
    ...
    def _load_calibration(self):
        ...
        self.dig_T2 = self._device.readU16LE(BMP280_REGISTER_DIG_T2)
        self.dig_T3 = self._device.readU16LE(BMP280_REGISTER_DIG_T3)

        self.dig_P1 = self._device.readU16LE(BMP280_REGISTER_DIG_P1)
        self.dig_P2 = self._device.readU16LE(BMP280_REGISTER_DIG_P2)
        self.dig_P3 = self._device.readU16LE(BMP280_REGISTER_DIG_P3)
        self.dig_P4 = self._device.readU16LE(BMP280_REGISTER_DIG_P4)
        self.dig_P5 = self._device.readU16LE(BMP280_REGISTER_DIG_P5)
        self.dig_P6 = self._device.readU16LE(BMP280_REGISTER_DIG_P6)
        self.dig_P7 = self._device.readU16LE(BMP280_REGISTER_DIG_P7)
        self.dig_P8 = self._device.readU16LE(BMP280_REGISTER_DIG_P8)
        self.dig_P9 = self._device.readU16LE(BMP280_REGISTER_DIG_P9)

        self.dig_H1 = self._device.readU16LE(BMP280_REGISTER_DIG_H1)
        self.dig_H2 = self._device.readU16LE(BMP280_REGISTER_DIG_H2)
        self.dig_H3 = self._device.readU16LE(BMP280_REGISTER_DIG_H3)
        self.dig_H6 = self._device.readU16LE(BMP280_REGISTER_DIG_P7)
        ...
        h5 = (h5 << 24) >> 20
        self.dig_H5 = h5 | (self._device.readU8(BMP280_REGISTER_DIG_H5)>> 4 & 0x0F)
    ...
    def read_raw_humidity(self):
        """Assumes that the temperature has already been reading.
        i.e. that enough delay has been provided."""
    ...
    @property
    def humidity(self):
        "Return the humidity in persent."
